...
wheel_dia, file_content, point_string = curve_to_wheel_points(gan_distance=gan_distance, gan_angle=gan_angle, mid_dia=mid_dia, work_lead=work_lead, if_plot=True)
